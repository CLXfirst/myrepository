...
public class Customer implements Serializable {
    ...
    private String others1; //个人简介
    private String others2;

    //constructor
    public Customer(){}

    public Customer(int custId, String custName, String custPwd, String custGender, long custTelno, String custEmail){
        this.custId = custId;
    ...
    public Customer(int custId, String custName, String custPwd, String custGender, long custTelno, String custEmail, Date custBirth, String custCountry, String custProvince, String custCity, String custProfile, int custScore, int custLevel, Date custRegistTime, Date custUpdateTime, int custStatus, String others1, String others2) {
        this.custId = custId;
        this.custName = custName;
        this.custPwd = custPwd;
        this.custGender = custGender;
    ...
    public Customer(String custName, String custPwd, String custGender, long custTelno, String custEmail, Date custBirth, String custCountry, String custProvince, String custCity, String custProfile, int custScore, int custLevel, Date custRegistTime, Date custUpdateTime, int custStatus, String others1, String others2) {
        this.custName = custName;
        this.custPwd = custPwd;
        this.custGender = custGender;
        this.custTelno = custTelno;
